...
#define STRING_CONFIG_H_AUTHOR "MysticGMAN" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Mystical Ender"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "80162f31-35e4-45d6-847b-d2a86567f447"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-5 Pro
    ...
    #define DEFAULT_Kp_LIST {  30.14,  30.14 }
    #define DEFAULT_Ki_LIST {   2.99,   2.99 }
    #define DEFAULT_Kd_LIST {  75.94,  75.94 }
  #else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1488.4, 109}
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44.0, -06.0, 0.00}
